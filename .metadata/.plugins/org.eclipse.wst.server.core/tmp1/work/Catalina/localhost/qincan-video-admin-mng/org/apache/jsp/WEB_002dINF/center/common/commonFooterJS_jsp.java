...
return;
    ...
    try {
      ...
      out.print(request.getContextPath() );
      out.write("\"/>\n");
      out.write("<input type=\"hidden\" id=\"apiServer\" name=\"apiServer\" value=\"http://192.168.31.98:8081\"/> \n");
      out.write("<input type=\"hidden\" id=\"bgmServer\" name=\"bgmServer\" value=\"http://192.168.31.98:8080/mvc\"/>\n");
