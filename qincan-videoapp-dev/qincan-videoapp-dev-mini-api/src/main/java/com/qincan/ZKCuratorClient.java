...
import com.qincan.ZKCuratorClient;
import com.qincan.cofig.ResourceConfig;
@Component
		...
		cache.getListenable().addListener(new PathChildrenCacheListener() {
			...
			public void childEvent(CuratorFramework client, PathChildrenCacheEvent event) throws Exception {
				...
				//	String songPath = bgm.getPath();
					...
					//2. 定义保存到本地的bgm路径
					//String filePath = "D:\\qincan_videos_dev" + songPath;
					...
					//String bgmUrl = "http://192.168.31.98:8080/mvc" + finalPath;
