...
public class VideoController extends BasicController {
	...
	public IMoocJSONResult upload(String userId, 
		...
		// 文件保存的命名空间
		//String fileSpace = "D:/qincan_videos_dev";
		String fileSpace = "C:/qincan_videos_dev";
		// 保存到数据库中的相对路径
	...
	public IMoocJSONResult uploadCover(String userId, 
		...
		if (StringUtils.isBlank(userId) || StringUtils.isBlank(videoId)) {
			return IMoocJSONResult.errorMsg("用户id或视频id为空...");
		}
