...
<!-- <input type="hidden" id="apiServer" name="apiServer" value="http://192.168.31.98:8081"/> 
<input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.31.98:8080/mvc"/> -->
<input type="hidden" id="apiServer" name="apiServer" value="http://203.195.242.196/v3"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://39.96.168.109/mvc"/>
